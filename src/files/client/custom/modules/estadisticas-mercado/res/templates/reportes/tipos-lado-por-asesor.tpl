...
<div class="em-page-header">
    <div class="em-header-icon"><i class="fas fa-user-tie"></i></div>
    <div>
        <h2 class="em-page-title">Tipos de Lado por Asesor</h2>
        <p class="em-page-sub">Conteo de lados por tipo (Captador/Cerrador) agrupados por asesor · <em>Excluye Noviembre y Diciembre</em></p>
    </div>
</div>
