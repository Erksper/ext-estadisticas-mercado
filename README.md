...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/EstadisticasMercado)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/EstadisticasMercado)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/EstadisticasMercado/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/EstadisticasMercado`
* `site/tests/integration/Espo/Modules/EstadisticasMercado`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/EstadisticasMercado/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/EstadisticasMercado/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/estadisticas-mercado/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/EstadisticasMercado/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/estadisticas-mercado/lib/some-lib.js"
    }
}
```
